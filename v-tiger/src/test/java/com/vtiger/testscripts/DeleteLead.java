...
public class DeleteLead extends BaseClass{
	...
	@Test
	public void deleteLead() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	{
	...
	Reporter.log("select the lead to be deleted", true);
	String lead2 = l.getSelectedlead().getText();
	l.getSelectedlead().click();
	Reporter.log("click on delete button", true);
	l.getDeletebtn().click();
	driver.switchTo().alert().accept();
	String lead3 = l.getLeadname().getText();
	
	Assert.assertNotEquals(lead2, lead3);
